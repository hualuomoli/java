package com.github.hualuomoli.raml.parser.java.transfer.json;
 ...
 *
 */
public class JsonJsonTransfer extends JavaJoinTransfer implements Transfer {
	...
	protected List<String> getSupportQueryMimeType() {
		return Lists.newArrayList(MIME_TYPE_JSON);
	}

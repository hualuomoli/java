...
public class RepeatController {
	...
	public String postJson(@RequestBody PostJsonJsonEntity postJsonJsonEntity, HttpServletRequest request, HttpServletResponse response) {
		// 设置属性
	...
	public String postUrlencoded(PostUrlencodedUrlEncodedEntity postUrlencodedUrlEncodedEntity, HttpServletRequest request, HttpServletResponse response) {
		// 设置属性
	...
	public String postFile(@RequestParam(value = "photo", required = true) MultipartFile[] photo, PostFileFileEntity postFileFileEntity,

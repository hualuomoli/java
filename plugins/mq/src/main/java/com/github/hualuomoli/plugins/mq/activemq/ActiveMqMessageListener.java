...
public class ActiveMqMessageListener extends DefaultMessageListenerContainer implements MessageListener {
	...
	private com.github.hualuomoli.plugins.mq.listener.MessageListener listener;

	public void setListener(com.github.hualuomoli.plugins.mq.listener.MessageListener listener) {

...
@WebAppConfiguration
@ContextConfiguration(classes = { BaseConfig.class, QueueDealerConfig.class, QueueSenderConfig.class })
@RunWith(SpringJUnit4ClassRunner.class)
public class QueueDealerConfigTest {
	...
	public void test() throws InterruptedException {
		if (messageSender.success()) {
			...
			for (int i = 0; i < count; i++) {
				messageSender.send("queue", "this is queue message from server.这是一段来自server的内容 " + i);
			}

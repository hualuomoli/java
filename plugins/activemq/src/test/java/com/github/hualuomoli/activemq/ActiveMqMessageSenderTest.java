...
public class ActiveMqMessageSenderTest {
	...
	// queue
	@Test
	public void testQueueSend() throws MessageException {
	...
	// topic
	@Test
	public void testTopicSend() throws MessageException {
		ActiveMqMessageSender sender = new ActiveMqMessageSender();
	...
	@Test
	public void testQueueReceive() throws MessageException, InterruptedException {
		...
		for (int i = 1; i < length; i++) {
			...
			// "classpath:spring/application-context-activemq-listener-queue.xml",
	...
	@SuppressWarnings("resource")
	@Test
	public void testTopicReceive() throws MessageException, InterruptedException {
		// message listener must manage by spring
		// so we load it
		...
		for (int i = 1; i < length; i++) {
			...
			// // add third listener
			// new ClassPathXmlApplicationContext(new String[] {
			// "classpath:spring/application-context-activemq-listener-topic.xml",
	...
	@SuppressWarnings("resource")
	@Test
	public void testSendUseActiveMqSecurity() throws MessageException {
		// load listener
	...
	@SuppressWarnings("resource")
	@Test
	public void testSendUseConnectPool() throws MessageException, InterruptedException {
		// load listener
	...
	@SuppressWarnings("resource")
	@Test
	public void testPersistentSend() throws MessageException, InterruptedException {
		// 默认持久化到硬盘
		// <persistenceAdapter>
		...
		// 关闭服务
		// 启动服务
		Thread.sleep(20 * 1000); // 休眠20s用于关闭和启动
	...
	@SuppressWarnings("resource")
	@Test
	public void testSendColony() throws MessageException, InterruptedException {
		// load listener
